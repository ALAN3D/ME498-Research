...
module groovemount_holes (){
	extruder_recess_d=16.25; 
	extruder_recess_h=7;

	extruder_recess_d2=11; 
	extruder_recess_h2=extruder_recess_h+2;

	// Recess in base
	translate([0,0,-1])
	cylinder(r=extruder_recess_d/2,h=extruder_recess_h+1);
	cylinder(r=extruder_recess_d2/2,h=extruder_recess_h2+1);		
}
